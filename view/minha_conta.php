    ...
    <div class="col-sm-4">
      <div class="card">
        <div class="card-body">
          ...
          <a href="<?= DIRACTION.'compra/listarCompras';?>" class="btn btn-teal my-account-btn">Continuar</a>
        </div>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="card">
        <div class="card-body">
          ...
          <a href="<?= DIRACTION.'cliente/meusEnderecos';?>" class="btn btn-teal my-account-btn">Continuar</a>
        </div>
      </div>
    </div>
    <div class="col-sm-4">
    ...
    <div class="col-sm-4">
      <div class="card">
        <div class="card-body">
          ...
          <a href="<?= DIRACTION.'cliente/dados';?>" class="btn btn-teal my-account-btn">Continuar</a>
        </div>
      </div>
    </div>
    <div class="col-sm-4">
